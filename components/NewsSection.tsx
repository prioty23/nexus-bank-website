...
export default function NewsSection() {
  ...
  return (
    <section id="support" className="section-padding bg-[#F8FAFC]">
      <div className="container-custom">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          ...
          <a href="#" className="btn-secondary self-start lg:self-auto">
            {t.news.viewAll}
          </a>
        </div>
          ...
          {t.news.items.map((item: string[], index: number) => (
            ...
            >
              ...
              <div className="p-7">
                ...
                <p className="mt-4 leading-7 text-gray-600">{item[5]}</p>
                <a
                  href="#"
                  className="mt-6 flex items-center justify-between border-t border-gray-100 pt-5 text-sm font-semibold text-[#006A4E]"
                >
